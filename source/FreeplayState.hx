...
class FreeplayState extends MusicBeatState
{
	...
	add(bg);
		...
		{
			var songText:Alphabet = new Alphabet(20, 20, songs[i].songName, true);
	...
	public function addWeek(songs:Array<String>, weekNum:Int, color:Int, ?songCharacters:Array<String>)
	{
